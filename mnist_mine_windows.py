...
def read_data_sets_microspheres(train_dir, 
  ...
  root_folder =r"C:\Users\Roarke\Desktop\microspheres simulations\classification\full set\\" 
  ##############################################################################
  ...
  # Step 1: get the images
  test_images = numpy.genfromtxt(root_folder + 'test_image_FP25_2k.txt')
  ...
  validation_images = train_images[:validation_size] # means validation is running from 0 to val size i specified above
